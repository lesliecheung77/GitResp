...
//import com.msb.internalcommon.request.PushRequest;
...
import com.msb.remote.ServiceSsePushClient;
...
//            List<TerminalResponse> data = new ArrayList<>();
            for (int j = 0; j < data.size(); j++) {
                ...
                if (availableDriver.getCode() == CommonStatusEnum.AVAILABLE_DRIVER_EMPTY.getCode()) {
                    ...
                    DriverCar carRemote = carById.getData();
    ...
    public ResponseResult passengerGetoff(@RequestBody OrderRequest orderRequest){
        ...
        ResponseResult<DriverCar> carById = serviceDriverUserClient.getCarById(orderInfo.getCarId());
